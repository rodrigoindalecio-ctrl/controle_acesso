                    ...
                    <div className={styles.section}>
                      <div className={styles.printHeader}>
                        ...
                        <div className={styles.printActions}>
                          ...
                          >
                            <option value="todos">Todos ({report.listaConvidados.length})</option>
                            <option value="presentes">Presentes ({report.listaConvidados.filter(c => c.presente).length})</option>
                            <option value="ausentes">Ausentes ({report.listaConvidados.filter(c => !c.presente).length})</option>
                          </select>
                          <button
                            type="button"
